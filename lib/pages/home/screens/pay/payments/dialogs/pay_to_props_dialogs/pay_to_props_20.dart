...
void getDialogPayToProps20(index) {
  ...
  Get.defaultDialog(
    ...
    title: controller.state.props[index].link,
    content: Padding(
          ...
          children: [
            TextField(
              ...
              decoration: const InputDecoration(
                ...
                labelText: 'Расчетный счет получателя',
              ),
              onEditingComplete: () {
            ...
            TextField(
              maxLength: 5,
              cursorColor: AppColors.primaryText,
              controller: controller.mfoController.value,
              keyboardType: TextInputType.number,
              textInputAction: TextInputAction.next,
              decoration: const InputDecoration(
                focusedBorder: OutlineInputBorder(
                ...
                border: OutlineInputBorder(
                    borderRadius: BorderRadius.all(Radius.circular(10))),
                labelText: 'МФО банка получателя',
              ),
              onChanged: (value) {
                if (value.length == 5) {
                  sendMsg.sendMessage(value);
                }
              },
            ),
            TextField(
              maxLength: 50,
              cursorColor: AppColors.primaryText,
              controller: controller.nameCorporateController.value,
              textInputAction: TextInputAction.next,
            ...
            TextField(
              maxLength: 200,
              cursorColor: AppColors.primaryText,
              controller: controller.appointController.value,
