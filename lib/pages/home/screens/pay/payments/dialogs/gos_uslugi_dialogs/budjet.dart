...
class BudgetDialog extends GetxController {
  ...
  void getFirstDialog(index) {
    ...
    //   payController.result.value = 'result';
    // });
    Get.defaultDialog(
        ...
        child: GetX<BudgetDialog>(
          ...
          builder: (logic) {
            return Column(
              ...
              children: [
                Image.asset(
                  controller.state.uslugi[index].iconLink,
                  width: 50.w,
                  height: 100.h,
                ),
                const SizedBox(
                ...
                TextField(
                  ...
                  onEditingComplete: () {
                    sendMsg.getDatas(controller.xrController.value.text);
                  },
                ),
                Text(
                  logic.result.value,
      ...
      cancel: ElevatedButton(
        ...
        child: Text(
          'Отмена',
          // payController.isProgress.value.toString(),
