...
class GosUslugiController extends GetxController {
  GosUslugiController();
  ...
  final currentWidget = Container().obs;
  ...
  final mibCheckingSuccess = false.obs;
  final mibPaid = false.obs;
  final mibPrintReceipt = false.obs;

  final state = GosUslugiState();
}
